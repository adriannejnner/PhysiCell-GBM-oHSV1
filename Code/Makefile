...
PROGRAM_NAME := GBM_OV_immune_stroma_patchy
...
PhysiCell_custom_module_OBJECTS := GBM_OV_immune_stroma_patchy.o
...
GBM_OV_immune_stroma_patchy.o: ./custom_modules/GBM_OV_immune_stroma_patchy.cpp 
	$(COMPILE_COMMAND) -c ./custom_modules/GBM_OV_immune_stroma_patchy.cpp
